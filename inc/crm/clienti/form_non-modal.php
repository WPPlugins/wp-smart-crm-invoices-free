...
jQuery(document).ready(function ($) {
  ...
  { 
    ...
    columns: [
      ...
      { 
        field: "nome", 
        title: "<?php _e('Nome','WPsmartcrm') ?>"
      }, 
      { 
        field: "cognome", 
        title: "<?php _e('Cognome','WPsmartcrm') ?>"
      }, 
      { 
        field: "email", 
      ...
      { 
        field: "telefono", 
        title: "<?php _e('Telefono','WPsmartcrm') ?>"
      },
      { 
        field: "qualifica", 
        title: "<?php _e('Qualifica','WPsmartcrm') ?>"
      },
...
<input type="hidden" name="MAX_FILE_SIZE" value="5000000">
    <h3><?php if ($ID) { ?> <?php _e('Cliente','WPsmartcrm')?>: <?php echo $riga["nome"]?> <?php echo $riga["cognome"]; } else{ ?> <?php _e('New Client','WPsmartcrm')?> <?php } ?></h3>
    <ul class="select-action">
        <li class="btn btn-success btn-sm _flat"><i class="glyphicon glyphicon-floppy-disk"></i> 
            <b onClick="check_form();return false;"> <?php _e('Save','WPsmartcrm')?></b>
        </li>
...
<div id="tabstrip" style="margin-top:14px">
    <ul>
        ...
        <li><?php _e('Contacts','WPsmartcrm')?></li>
        <li><?php _e('Notes','WPsmartcrm')?></li>
        <li><?php _e('Summary','WPsmartcrm')?></li>
    </ul>
    <!-- TAB 1 -->
<div>
<div id="d_anagrafica">
...
<div class="row form-group">
	<label class="col-sm-1 control-label"><?php _e('Codice fiscale','WPsmartcrm')?></label>
...
<div class="row form-group">
	<label class="col-sm-1 control-label"><?php _e('Skype','WPsmartcrm')?></label>
	<div class="col-sm-4"><input type="text" name="skype" size="20" maxlength='100' value="<?php echo $riga["skype"]?>" class="form-control">
	</div>
</div>
<div class="row form-group">
	<label class="col-sm-1 control-label"><?php _e('Agent','WPsmartcrm')?>:</label>
...
?>
<div class="row form-group">
	<label class="col-sm-1 control-label"><?php _e('Create User','WPsmartcrm')?>?</label>
...
<table>
<tr>
	<td align="center"><?php _e('Notes','WPsmartcrm')?></td>
</tr>
<tr>
