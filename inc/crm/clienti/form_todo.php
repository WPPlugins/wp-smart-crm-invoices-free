        ...
        <div class="panel-body" style="padding:20px">
            <div class="row" style="padding-bottom:2px;padding-top:0px;border-bottom:1px solid #ccc">
                <div class="col-md-12 form-group">
                    <label class="col-sm-1 control-label"><?php _e( 'Expiration', 'WPsmartcrm' ); ?></label>
                    <div class="col-md-4">
            ...
            <div class="row" style="padding-bottom:2px;padding-top:0px;">
                <div class="col-md-5 form-group">
                    <label><?php _e( 'Subject', 'WPsmartcrm' ); ?> </label>
                    <input type="text" name="t_oggetto" id='t_oggetto' class="form-control _m k-textbox" placeholder="<?php _e('Type a subject for this Item','WPsmartcrm')?>">
                </div>

                <div class="col-md-6 form-group">
                    <label><?php _e( 'Notes', 'WPsmartcrm' ); ?></label>
            ...
            <div class="row col-md-12" style="background:#e2e2e2;padding:1px 10px;margin-bottom:10px">
                <div class="col-md-12"><h2><?php _e( 'Notifications rules for this TODO', 'WPsmartcrm' ); ?></h2></div>
            </div>
            <div class="row" style="padding-bottom:2px;padding-top:0px;border-bottom:1px solid #ccc">
            ...
            <div class="row" style="padding-bottom:2px;padding-top:0px;border-bottom:1px solid #ccc">
                <div class="col-md-4">
                    <label style="line-height: 1em;"><?php _e( 'Notify to User', 'WPsmartcrm' ); ?></label>
                    <input class="ruleActions" id="t_remindToUser" name="t_remindToUser" />
                </div>
                <div class="col-md-7">
                    <label>
                        <?php _e( 'Publish on user dashboard', 'WPsmartcrm' ); ?>?<br />
            ...
            <div class="row" style="padding-bottom:2px;padding-top:0px;border-bottom:1px solid #ccc">
                <div class="col-md-4">
                    <label style="line-height: 1em;"><?php _e( 'Notify to Group', 'WPsmartcrm' ); ?></label>
            ...
            <div class="row" style="padding:16px">
                <span class="btn btn-success _flat" id="t_saveStep"><?php _e( 'Save', 'WPsmartcrm' ); ?></span>
                <span class="btn btn-warning _flat _reset" id="t_configreset"><?php _e( 'Reset', 'WPsmartcrm' ); ?></span>
            </div>
        </div>       
    </div>
