...
if ($qd)
{
	$_header="<th class=\"WPsCRM_items_header WPsCRM_cod\">".__('Code','WPsmartcrm')."</th><th class=\"WPsCRM_items_header WPsCRM_desc\">".__('Description','WPsmartcrm')."</th><th class=\"WPsCRM_items_header WPsCRM_qty\">".__('Quantity','WPsmartcrm')."</th><th class=\"WPsCRM_items_header WPsCRM_price\">".__('Price','WPsmartcrm')."</th><th class=\"WPsCRM_items_header WPsCRM_discount\">".__('Discount','WPsmartcrm')."</th><th class=\"WPsCRM_items_header WPsCRM_total\">".__('Total','WPsmartcrm')."</th>";
	$t_articoli='
...
if ($totale_righe)
{
	...
	$tab_tot="
  	<tr class='total_net'><td>".__("Total Net",'WPsmartcrm')."</td><td align='right'>".WPsCRM_get_currency()->symbol." ".number_format($totale_imponibile, 2, ',', '.')."</td></tr>
	<tr class='total_gros' style='display:none'><td>".__("Price",'WPsmartcrm')."</td><td align='right'>".WPsCRM_get_currency()->symbol." ".number_format($totale_netto, 2, ',', '.')."</td></tr>
  	<tr class=\"print_tax\"><td >".__("Total Tax",'WPsmartcrm')."</td><td align='right'>".WPsCRM_get_currency()->symbol." ".number_format($totale_imposta, 2, ',', '.')."</td></tr>";
	if (isset($totale_rimborso) && $totale_rimborso!=0)
		$tab_tot.="<tr class=\"WPsCRM_rowRefund\"><td>".__("Refund",'WPsmartcrm')."</td><td align='right'>".WPsCRM_get_currency()->symbol." ".number_format($totale_rimborso, 2, ',', '.')."</td></tr>
  	";
	$tab_tot.="<tr class=\"WPsCRM_grandTotal\"><td><h4>".__("Grand Total",'WPsmartcrm')."</h4></td><td align='right'><h4>".WPsCRM_get_currency()->symbol." ".number_format($totale_netto, 2, ',', '.')."</h4></td></tr>
  ";
}
