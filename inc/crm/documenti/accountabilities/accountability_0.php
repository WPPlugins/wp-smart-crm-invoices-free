...
<table class="table table-striped table-bordered col-md-11" id="t_art" style="width:95%!important">
	<thead>
		<tr>
			<th>
				<?php _e('Code','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Description','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Rule','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Q.ty','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Price','WPsmartcrm')?>
			</th>
			<th style="min-width:68px">
				<?php _e('Discount','WPsmartcrm')?><br />
			...
			<th>
				<?php _e('VAT','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Total','WPsmartcrm')?>
			</th>
			<th>
				<?php _e('Actions','WPsmartcrm')?>
			</th>
		</tr>
	</thead>
	<tbody>
		...
		if(amount !="")
		{
			jQuery.ajax({
                ...
                success: function (result) {
					...
					jQuery('#t_art').append('<tr class="riga" id="r_' + n_row + '"><td><input type="hidden" name="tipo_' + n_row + '" id="tipo_' + n_row + '" value="2"><input type="text" size="10" name="codice_' + n_row + '" id="codice_' + n_row + '" value=""></td><td><textarea rows="1" style="width:93%"  name="descrizione_' + n_row + '" id="descrizione_' + n_row + '" class="descriptive_row"></textarea></td><td></td><td><input type="text" size="4" name="qta_' + n_row + '" id="qta_' + n_row + '" onblur="aggiornatot()" value="1"></td><td><input type="text" size="10" name="prezzo_' + n_row + '" id="prezzo_' + n_row + '" value="'+result+'"  onblur="aggiornatot()"  oninput="aggiornatot()"></td><td><input type="text" size="4" name="sconto_' + n_row + '" id="sconto_' + n_row + '" size="5"  onblur="aggiornatot()"  oninput="aggiornatot()"></td><td><input type="text" size="4" name="iva_' + n_row + '" id="iva_' + n_row + '" value="' + def_iva + '" size="5"  onblur="aggiornatot()" oninput="aggiornatot()"></td><td><input type="text" size="4" name="totale_' + n_row + '" id="totale_' + n_row + '" value=""></td><td><button type="button"  onclick="elimina_riga(0,' + n_row + ')"><?php _e('Delete','WPsmartcrm')?></button></td></tr>');
					aggiornatot();
					window.sessionStorage.setItem('ref_row',n_row);
					if (refund)
					{
						var n_row=jQuery('#t_art > tbody > tr').length+1;
						jQuery('#t_art').append('<tr class="riga riga_refund" id="r_' + n_row + '"><td colspan="3"><input type="hidden" name="tipo_' + n_row + '" id="tipo_' + n_row + '" value="4"><textarea rows="1" style="width:93%"  name="descrizione_' + n_row + '" id="descrizione_' + n_row + '" class="descriptive_row"></textarea></td><td><input type="text" size="4" name="qta_' + n_row + '" id="qta_' + n_row + '" onblur="aggiornatot()" value="1"></td><td><input type="text" size="10" name="prezzo_' + n_row + '" id="prezzo_' + n_row + '"  value="'+refund+'" onblur="aggiornatot()"  oninput="aggiornatot()"></td><td></td><td></td><td><input type="text" size="4" name="totale_' + n_row + '" id="totale_' + n_row + '" value="'+refund+'"></td><td><button type="button"  onclick="elimina_riga(0,' + n_row + ')"><?php _e('Delete','WPsmartcrm')?></button></td></tr>');
					}
...
function addRow(id, codice, descrizione, iva, prezzo, arr_rules, rule)
	{
		...
		s_select+='</select>';
		jQuery('#t_art').append('<tr class="riga" id="r_' + n_row + '"><td><input type="hidden" id="tipo_' + n_row + '" name="tipo_' + n_row + '" value="1"><input type="hidden" name="id_' + n_row + '" value="' + id + '"><input type="text" size="10" name="codice_' + n_row + '" id="codice_' + n_row + '" value="' + codice + '"></td><td><textarea  name="descrizione_' + n_row + '" id="descrizione_' + n_row + '" style="width:93%" class="descriptive_row">' + descrizione + '</textarea></td><td>' + s_select + '</td><td><input type="text" size="4" name="qta_' + n_row + '" id="qta_' + n_row + '"  onblur="aggiornatot()" value="1" /></td><td><input type="text" size="10" name="prezzo_' + n_row + '" id="prezzo_' + n_row + '" value="' + prezzo + '"  onblur="aggiornatot()"></td><td><input type="text" size="4" name="sconto_' + n_row + '" id="sconto_' + n_row + '" size="5"  onblur="aggiornatot()"></td><td><input type="text" size="4" name="iva_' + n_row + '" id="iva_' + n_row + '" value="' + iva + '" size="5"  onblur="aggiornatot()"></td><td><input type="text" size="4" name="totale_' + n_row + '" id="totale_' + n_row + '"></td><td><button type="button"  onclick="elimina_riga(0,' + n_row + ')"><?php _e('Delete','WPsmartcrm')?></button></td></tr>');
		aggiornatot();
	}
    ...
    function elimina_riga(id_art, riga) {
        if (!confirm("<?php _e('Confirm delete? Deletion will not have effect until you save the document','WPsmartcrm')?>"))
            return false;
	...
	function add_manual_row()
    {
        jQuery.ajax({
            ...
            success: function (result) {
                ...
                s_select+='</select>';
                jQuery('#t_art').append('<tr class="riga" id="r_' + n_row + '"><td><input type="hidden" name="tipo_' + n_row + '"  id="tipo_' + n_row + '" value="2"><input type="text" size="10" name="codice_' + n_row + '" id="codice_' + n_row + '" value=""></td><td><textarea rows="1" style="width:93%"  name="descrizione_' + n_row + '" id="descrizione_' + n_row + '" class="descriptive_row"></textarea></td><td>' + s_select + '</td><td><input type="text" size="4" name="qta_' + n_row + '" id="qta_' + n_row + '" onblur="aggiornatot()"></td><td><input type="text" size="10" name="prezzo_' + n_row + '" id="prezzo_' + n_row + '" value=""  onblur="aggiornatot()"  oninput="aggiornatot()"></td><td><input type="text" size="4" name="sconto_' + n_row + '" id="sconto_' + n_row + '" size="5"  onblur="aggiornatot()"  oninput="aggiornatot()"></td><td><input type="text" size="4" name="iva_' + n_row + '" id="iva_' + n_row + '" value="' + iva + '" size="5"  onblur="aggiornatot()" oninput="aggiornatot()"></td><td><input type="text" size="4" name="totale_' + n_row + '" id="totale_' + n_row + '"></td><td><button type="button"  onclick="elimina_riga(0,' + n_row + ')"><?php _e('Delete','WPsmartcrm')?></button></td></tr>');
            },
            error: function (errorThrown) {
                console.log(errorThrown);
            }
  ...
  function add_descriptive_row()
	...
	function add_refund_row(){
		var n_row=jQuery('#t_art > tbody > tr').length+1;
        jQuery('#t_art').append('<tr class="riga riga_refund" id="r_' + n_row + '"><td colspan="3"><input type="hidden" name="tipo_' + n_row + '" id="tipo_' + n_row + '" value="4"><textarea rows="1" style="width:93%"  name="descrizione_' + n_row + '" id="descrizione_' + n_row + '" class="descriptive_row"></textarea></td><td><input type="text" size="4" name="qta_' + n_row + '" id="qta_' + n_row + '" onblur="aggiornatot()"></td><td><input type="text" size="10" name="prezzo_' + n_row + '" id="prezzo_' + n_row + '" value=""  onblur="aggiornatot()"  oninput="aggiornatot()"></td><td></td><td></td><td><input type="text" size="4" name="totale_' + n_row + '" id="totale_' + n_row + '"></td><td><button type="button"  onclick="elimina_riga(0,' + n_row + ')"><?php _e('Delete','WPsmartcrm')?></button></td></tr>');
	}
