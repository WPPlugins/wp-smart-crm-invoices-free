...
$subheader.='</div>';
$subheader .='<div class="col-md-6 WPsCRM_documentData"><b>'.$document_name.' # '.$n_offerta.' '.__("issued on",'WPsmartcrm').' '.WPsCRM_culture_date_format($riga["data"]).'</b></div>';
$subheader .='</section>';
//document body
...
<div class="box wide hidden-on-narrow">
	...
	<div class="box-col row">
		...
		<div class="col-md-2">
			<h4>
				<?php _e('Get PDF','WPsmartcrm')?>
			</h4>
			<button class="export-pdf btn _flat btn-success">
				<?php _e('Download','WPsmartcrm')?>
			</button>
		...
		<div class="col-md-9">
			<h4>
				<?php _e('Print options','WPsmartcrm') ?>
			</h4>
	...
	jQuery(document).ready(function ($) {
        ...
        .done(function (data) {
        	...
        	setTimeout(function () {
        		...
        		$('.export-info').html("<br><?php _e('The current document has been downloaded in your PC and saved on the server in','WPsmartcrm')?>:<br><small style=\"background:gold;font-size:small;padding:3px\"><a href=\"<?php echo content_url() ?>/uploads/CRMdocuments/<?php echo $random_name?>\" target=\"_blank\"><?php echo content_url() ?>/uploads/CRMdocuments/<?php echo $random_name?></a></small>")
        		//$('.export-info').append('<br><br><span class="btn btn-info _flat"><?php _e('Send to customer','WPsmartcrm')?></span>')
        	}, 700)
