...
if ( in_array( 'wp-smart-crm-accountability/wp-smart-crm-accountability.php', apply_filters( 'active_plugins', $filter) ) ) {
	...
	<li class="btn bg-danger btn-sm _flat btn_todo" onclick="location.href='<?php echo admin_url('admin.php?page=smart-crm&p=documenti/form_credit_note.php')?>';return false;">
		...
		<b>
			<?php _e('NEW CREDIT NOTE','WPsmartcrm')?>
		</b>
	</li>
		<?php
	}
	...
	<span style="float:right;">
		<li class="no-link" style="margin-top:4px">
			<?php _e('Registered invoices (underlined) cannot be edited or deleted.','WPsmartcrm')?>
			<i class="glyphicon glyphicon-fire"></i>= <?php _e('Invoice','WPsmartcrm')?>
			<i class="glyphicon glyphicon-send"></i>= <?php _e('Quote','WPsmartcrm')?>
		</li>
	</span>
</ul>
...
<div id="documentsTabstrip">
	<ul>
		<li class="k-state-active">
			<i class="glyphicon glyphicon-fire"></i><?php _e('INVOICES','WPsmartcrm')?>
		</li>
		<li>
			<i class="glyphicon glyphicon-send"></i><?php _e('QUOTES','WPsmartcrm')?>
		</li>
