...
<form name="form_insert" action="<?php echo admin_url('admin.php?page=smart-crm&p=documenti/insert.php&type=4&ID='.$ID.'&security='.$update_nonce); echo isset($_REQUEST['layout']) ? "&layout=".$_REQUEST['layout'] : null?>" method="post" id="form_insert">
    ...
    <h1 style="text-align:center"><?php _e('CREATE/EDIT CREDIT NOTE','WPsmartcrm')?> <i class="glyphicon glyphicon-fire"></i></h1>
    <div id="tabstrip">
        <ul>
            <li id="tab1"><?php _e('CREDIT NOTE','WPsmartcrm')?></li>
            <li onclick="aggiornatot();"><?php _e('COMMENTS AND INTERNAL DATA','WPsmartcrm')?></li>
        </ul>
        <div>
            <h4 class="page-header" style="margin: 10px 0 20px;">
                <?php _e('CREDIT NOTE DATA','WPsmartcrm')?><span class="crmHelp" data-help="document-data"></span>
                <?php if ($ID) {?>
            ...
            <section id="notifications" style="display:none!important">
                <h4 class="page-header"><?php _e('Credit note payment reminder','WPsmartcrm')?> </h4>
            ...
            <h4 class="page-header"><?php _e('Add Products to credit note','WPsmartcrm')?><span class="crmHelp" data-help="invoice-products"></span>
