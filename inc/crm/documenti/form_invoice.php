...
<form name="form_insert" action="<?php echo admin_url('admin.php?page=smart-crm&p=documenti/insert.php&type=2&ID='.$ID.'&security='.$update_nonce); echo isset($_REQUEST['layout']) ? "&layout=".$_REQUEST['layout'] : null?>" method="post" id="form_insert">
	<input type="hidden" name="num_righe" id="num_righe" value="">
    <h1 style="text-align:center"><?php _e('CREATE/EDIT INVOICE','WPsmartcrm')?> <i class="glyphicon glyphicon-fire"></i></h1>
    <div id="tabstrip">
        <ul>
        ...
        <div>
            <h4 class="page-header" style="margin: 10px 0 20px;float: left;padding: 6px 0;width:100%">
                ...
                <span class="col-md-2" style="line-height:32px">
					<?php _e('INVOICE DATA','WPsmartcrm')?>
				</span>

                <label class="control-label col-md-1"><?php _e('Issue Date','WPsmartcrm')?></label>
                <?php if ($ID) {?>
                ...
                <label class="col-sm-1 control-label"><?php _e('Number','WPsmartcrm')?></label>
                <span class="col-sm-2">
                    <input name="progressivo" id="progressivo" class="form-control" data-placement="bottom" title="<?php _e('Number','WPsmartcrm')?>" value="<?php if (isset($riga)) echo $riga["progressivo"]?>" readonly disabled />
                </span>

                <?php if ($ID) {?>
                <span style="/*float:right;*/font-size:.8em;text-decoration:underline;cursor:pointer;margin-top: 8px;" class="_edit_header col-md-1">
				<i class="glyphicon glyphicon-pencil"></i> <?php _e('Edit','WPsmartcrm')?>
				</span>
                <?php } ?>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-2">
                    ...
                    <select name="modalita_pagamento" id="modalita_pagamento" class="_form-control col-md-12">
                        <option value="0" <?php if (isset($riga) && $payment==0) echo "selected"?>><?php _e('Select','WPsmartcrm')?></option>
                        <?php
                ...
                <label class="control-label  col-md-1"><?php _e('Payment exp. Date','WPsmartcrm')?></label>
                ...
                {
                ?>
                <label class="control-label col-md-1" style="width:30px"><?php _e('Paid','WPsmartcrm')?>?</label>
                ...
                ?>
                <label class="control-label col-md-1" style="width:30px"><?php _e('Notify','WPsmartcrm')?>? </label>
            ...
            <section id="notifications" style="display:none!important">
                ...
                <div class="row form-group">
                    ...
                    <label class="col-sm-1"><?php _e('Days after expiration','WPsmartcrm')?></label><div class="col-sm-2"><input class="ruleActions" id="notificationDays" name="notificationDays" type="number" value="<?php if (isset($$giorni_pagamento)) echo $giorni_pagamento?>"><small id="changeNoty"><a href="#" onclick="return false;"><?php _e('Edit default value','WPsmartcrm')?>&raquo;</a></small></div>
...
<div id="dialog-view" style="display:none;margin: 0 auto; text-align: center; z-index: 1000; width: 100%; height: 100%; background: url('<?php echo str_replace("inc/crm/documenti/","",plugin_dir_url( __FILE__ ))?>css/img/bg_w_tr.png');position: absolute;left: 0;top:0;"  class="_modal" data-from="documenti">
    ...
    <div class="panel-body" style="padding:50px">
        <label><?php  _e('Change default value','WPsmartcrm')?></label><input class="ruleActions" name="new_default_noty" id="new_default_noty" type="number" value="<?php if (isset($documentOptions['invoice_noty_days'])) echo $documentOptions['invoice_noty_days']?>">
