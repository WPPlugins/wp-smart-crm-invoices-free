...
var dataSource = new kendo.data.DataSource({
  ...
  //total:data.length()
        ...
        $("#grid").kendoGrid({
            ...
            columns: [{ field: "ID", title: "ID" }, { field: "codice", title: "<?php _e('Code','WPsmartcrm') ?>" }, { field: "descrizione", title: "<?php _e('Description','WPsmartcrm') ?>" }, { field: "listino1", title: "<?php _e('Price','WPsmartcrm') ?>" },
              { command: [
                {
...
<ul class="select-action">
         ...
         <i class="glyphicon glyphicon-plus"></i><b> <?php _e('New Item','WPsmartcrm') ?></b>
            </li>
