...
<div class="_smartcrm_service">
    <h3 style="margin:10px"><?php _e('Welcome','WPsmartcrm')?>  <?php echo $current_user->display_name ?> <small style="margin-right:20px;float:right"><a href="<?php  echo wp_logout_url( home_url()  ); ?>"><?php _e('Logout','WPsmartcrm')?></a></small></h3>
<ul class="tabs">
  <li class="active" rel="tab1"><?php _e('Profile Data','WPsmartcrm')?></li>
  <li rel="tab2"><?php _e('Invoices','WPsmartcrm')?></li>
...
<div class="tab_container">
  ...
  <h2><?php _e('Profile data','WPsmartcrm')?></h2>
    <?php include(dirname(__FILE__).'/user-tabs/tab1-form.php')?>
  </div>
  <!-- #tab1 -->
  <h3 class="tab_drawer_heading" rel="tab2">Tab 2</h3>
  <div id="tab2" class="tab_content">
  <h2><?php _e('Your Invoices','WPsmartcrm')?></h2>
