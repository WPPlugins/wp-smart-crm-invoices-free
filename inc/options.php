...
?>
        ...
        <?php
		echo '<h1>'.__('WP smart CRM options and Settings','WPsmartcrm').'</h1>';
	}
	function footer(){
	...
	function register_business_settings() {
		$this->plugin_settings_tabs[$this->business_settings_key] =  __('Business' , 'WPsmartcrm' );
		register_setting( $this->business_settings_key, $this->business_settings_key );
		add_settings_section( 'section_business', __( 'Business Settings', 'WPsmartcrm' ), array( &$this, 'section_business_desc' ), $this->business_settings_key );
		add_settings_field( 'business', __( '', 'WPsmartcrm' ), array( &$this, 'smartcrm_business_info' ), $this->business_settings_key, 'section_business' );
	}
	
	function register_general_settings() {
		$this->plugin_settings_tabs[$this->general_settings_key] =  __('General' , 'WPsmartcrm' );
		register_setting( $this->general_settings_key, $this->general_settings_key );
		add_settings_section( 'section_general', __('General CRM Settings' , 'WPsmartcrm' ).'<span class="crmHelp crmHelp-dark _options" data-help="general-options"></span>', array( &$this, 'section_general_desc' ), $this->general_settings_key );
		add_settings_field( 'redirect', __( 'Redirect to CRM', 'WPsmartcrm' ), array( &$this, 'smartcrm_redirect' ), $this->general_settings_key, 'section_general' );
		add_settings_field( 'minimize', __( 'Minimize WP Menu', 'WPsmartcrm' ), array( &$this, 'smartcrm_minimize_WP_menu' ), $this->general_settings_key, 'section_general' );
		//add_settings_field('services', __( 'Activate Services Module', 'WPsmartcrm' ), array( &$this, 'smartcrm_checkbox_services'),$this->general_settings_key,'section_general' );
		add_settings_field('company_logo', __( 'Company Logo', 'WPsmartcrm' ),array( &$this, 'smartcrm_company_logo'), $this->general_settings_key, 'section_general' );
		add_settings_field('print_logo', __( 'Use Logo in documents (invoices, offers)', 'WPsmartcrm' ),array( &$this, 'smartcrm_print_logo'), $this->general_settings_key, 'section_general' );
		add_settings_field('show_all_for_administrators', __( 'Show all notifications to administrators', 'WPsmartcrm' ),array( &$this, 'smartcrm_administrator_noty'), $this->general_settings_key, 'section_general' );
		add_settings_field('future_activity', __( 'Do not show closed past activities  in scheduler and dashboard', 'WPsmartcrm' ),array( &$this, 'smartcrm_show_future_activity'), $this->general_settings_key, 'section_general' );
		add_settings_field('activity_deletion', __( 'Allow deletion of activities ( todo, appointments )', 'WPsmartcrm' ),array( &$this, 'smartcrm_activity_deletion_privileges'), $this->general_settings_key, 'section_general' );
		add_settings_field( 'agent_can', __( 'Extend agent capabilities' , 'WPsmartcrm' ), array( &$this, 'smartcrm_agent_can' ), $this->general_settings_key, 'section_general' );
		add_settings_field( 'emailfrom', __( 'Set email  sender for notification', 'WPsmartcrm' ), array( &$this, 'smartcrm_sender_email' ), $this->general_settings_key, 'section_general' );
		add_settings_field( 'emailfromLabel', __( 'Set sender name for notification' , 'WPsmartcrm' ), array( &$this, 'smartcrm_sender_name' ), $this->general_settings_key, 'section_general' );
		add_settings_field( 'customersGridHeight', __( 'Set grid height for customers' , 'WPsmartcrm' ), array( &$this, 'smartcrm_customers_grid_height' ), $this->general_settings_key, 'section_general' );
		add_settings_field( 'documentsGridHeight', __( 'Set grid height for documents' , 'WPsmartcrm' ), array( &$this, 'smartcrm_documents_grid_height' ), $this->general_settings_key, 'section_general' );

		do_action('WPsCRM_register_additional_general_options');
	}

	function register_clients_settings() {
		$this->plugin_settings_tabs[$this->clients_settings_key] = __('Customers' , 'WPsmartcrm' ) ;
		register_setting( $this->clients_settings_key, $this->clients_settings_key );
		add_settings_section( 'section_clients', __( 'Customers Settings', 'WPsmartcrm' ) , array( &$this, 'section_clients_desc' ), $this->clients_settings_key );
		add_settings_field('clientsCategories',__( 'Customers categories', 'WPsmartcrm' ).'<span class="crmHelp crmHelp-dark" data-help="customer-categories"></span>', array( &$this, 'smartcrm_add_client_category'), $this->clients_settings_key, 'section_clients' );
		//add_settings_field('clientsTax',__( 'Show taxonomies in grid', 'WPsmartcrm' ), array( &$this, 'smartcrm_tax_columns'), $this->clients_settings_key, 'section_clients' );
		do_action('WPsCRM_register_additional_clients_options');
	}

	function register_documents_settings() {
		$this->plugin_settings_tabs[$this->documents_settings_key] =  __( 'Documents', 'WPsmartcrm' );
		register_setting( $this->documents_settings_key, $this->documents_settings_key );
		add_settings_section( 'section_documents', __( 'Documents Settings', 'WPsmartcrm' ), array( &$this, 'section_documents_desc' ), $this->documents_settings_key );
		//add_settings_field( 'delayedPayments', __( '', 'WPsmartcrm' ),  array( &$this,'smartcrm_add_payment_description'), $this->documents_settings_key, 'section_documents' );
		add_settings_field( 'document_header', __( '', 'WPsmartcrm' ),  array( &$this,'smart_crm_documents_settings'), $this->documents_settings_key, 'section_documents' );
	...
	function register_services_settings() { //conditional if services module is activated in general options
		...
		if( isset($options['services']) && $options['services'] ==1){
			$this->plugin_settings_tabs[$this->services_settings_key] =  __( 'Services', 'WPsmartcrm' );
			
			register_setting( $this->services_settings_key, $this->services_settings_key );
			/**
			 * Section services removed until next release
			 **/
			//add_settings_section( 'section_services', __( 'Services Settings', 'WPsmartcrm' ), array( &$this, 'section_services_desc' ), $this->services_settings_key );
			add_settings_field('currency', __( 'Currency', 'WPsmartcrm' ), array( &$this,'smartcrm_currency_select' ),$this->services_settings_key,'section_services' );
			add_settings_field('gateways',__( 'Payment gateways', 'WPsmartcrm' ), array( &$this,'smartcrm_gateway_select' ),$this->services_settings_key,'section_services' );
		}
	}
	function register_woo_settings(){
		$this->plugin_settings_tabs[$this->woo_settings_key] =  __( 'Woocommerce settings', 'WPsmartcrm' );
		register_setting( $this->woo_settings_key, $this->woo_settings_key );
		add_settings_section( 'section_woocommerce', __( 'Woocommerce Settings', 'WPsmartcrm' ), array( &$this, 'section_woo_desc' ), $this->woo_settings_key );
		do_action('WPsCRM_add_woo_settings_fields');
	}
	function register_acc_settings(){
		$this->plugin_settings_tabs[$this->acc_settings_key] =  __( 'Accountability settings', 'WPsmartcrm' );
		register_setting( $this->acc_settings_key, $this->acc_settings_key );
		add_settings_section( 'section_accountability', __( 'Accountability Settings', 'WPsmartcrm' ), array( &$this, 'section_acc_desc' ), $this->acc_settings_key );
		do_action('WPsCRM_add_acc_settings_fields');
	}
	function register_adv_settings(){
		$this->plugin_settings_tabs[$this->adv_settings_key] =  __( 'Advanced settings', 'WPsmartcrm' );
		register_setting( $this->adv_settings_key, $this->adv_settings_key );
		add_settings_section( 'section_advanced', __( 'Advanced Settings', 'WPsmartcrm' ), array( &$this, 'section_adv_desc' ), $this->adv_settings_key );
	...
	function smartcrm_business_info(){
        ...
        ?>
			<div id="pages" class="col-md-12">
                    <div id="pages-title"><h4 class="page-header" style="text-align:center"><span class="crmHelp crmHelp-dark" data-help="business-data" data-role="tooltip"></span><?php _e('Business main data','WPsmartcrm')?><small style="font-size:small"> - <?php _e('These info will create customer # 1 (for self todo) at plugin activation and will be used in documents ( invoices, offers, etc)','WPsmartcrm')?></small></h4></div>
                    <div id="sortable-handlers">
                        <div class="item">
                            <label><?php _e('Business Name','WPsmartcrm')?> ( <span style="color:red"> * </span> )</label><br />
                        ...
                        <div class="item">
                            <label><?php _e('Address (street, number)','WPsmartcrm')?> ( <span style="color:red"> * </span> )</label><br />
                        ...
                        <div class="item">
                            <label><?php _e('Town','WPsmartcrm')?> ( <span style="color:red"> * </span> )</label><br />
                        ...
                        <div class="item">
                            <label><?php _e('ZIP code','WPsmartcrm')?> ( <span style="color:red"> * </span> )</label><br />
                        ...
                        <div class="item">
                            <label><?php _e('Vat Code','WPsmartcrm')?>  ( <span style="color:red"> * </span> )</label><br />
                        ...
                        <div class="item">
                            <label><?php _e('Cod. Fisc.','WPsmartcrm')?></label><br />
                        ...
                        <div class="item">
                            <label><?php _e('Phone','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_phone" name="CRM_business_settings[business_phone]" value="<?php echo $options['business_phone'] ?>"  class="form-control _m" /><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_phone]" <?php echo (isset($options['show_phone']) &&  $options['show_phone']=="1" ? 'checked' :null) ?>/></label><br />
                        </div>
                        <div class="item">
                            <label><?php _e('Fax','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_fax" name="CRM_business_settings[business_fax]" value="<?php echo $options['business_fax'] ?>"  class="form-control _m" /><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_fax]" <?php echo (isset($options['show_fax'] ) && $options['show_fax'] =="1" ? 'checked' :null) ?>/></label><br />
                        </div>
                        <div class="item">
                            <label><?php _e('Email','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_email" name="CRM_business_settings[business_email]" value="<?php echo $options['business_email'] ?>"  class="form-control _m" /><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_email]" <?php echo (isset($options['show_email'] ) && $options['show_email'] =="1" ? 'checked' :null) ?>/></label><br />

                        </div>
                        <div class="item">
                            <label><?php _e('Web Site','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_web" name="CRM_business_settings[business_web]" value="<?php echo $options['business_web'] ?>"  class="form-control _m"><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_web]" <?php echo (isset($options['show_web'] ) && $options['show_web'] =="1" ? 'checked' :null) ?>/></label><br />
                        </div>
                        <div class="item">
                            <label><?php _e('Bank account code (IBAN)','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_iban" name="CRM_business_settings[business_iban]"  value="<?php echo $options['business_iban'] ?>"  class="form-control _m"/><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_iban]" <?php echo (isset($options['show_iban'] ) && $options['show_iban'] =="1" ? 'checked' :null) ?>/></label><br />
                        </div>
                        <div class="item">
                            <label><?php _e('Int. account code (SWIFT)','WPsmartcrm')?></label><br />
                            <input type="text" id="crm_business_swift" name="CRM_business_settings[business_swift]" value="<?php echo $options['business_swift'] ?>" class="form-control _m" /><label class="toRight"><?php _e('Show in document header','WPsmartcrm')?>?<input type="checkbox" value="1" name="CRM_business_settings[show_swift]" <?php echo (isset($options['show_swift']) && $options['show_swift'] =="1" ? 'checked' :null) ?> /></label><br />
                        </div>
                        ...
                        <span  class="_flat btn btn-success" value="Save" style="margin: 30px;" onclick="saveBusiness()"><?php _e('Save','WPsmartcrm')?></span> 
                    </div>
                </div>	
			<style>
			...
			<script>
				...
				messages: {
					hasName: "<?php _e('Business name is required','WPsmartcrm')?>",
					hasAddress: "<?php _e('Address is required','WPsmartcrm')?>",
					hasTown: "<?php _e('Town is required','WPsmartcrm')?>",
					hasZip: "<?php _e('Zip code is required','WPsmartcrm')?>",
					hasCF: "<?php _e('Vat Code is required','WPsmartcrm')?>",
        ...
        ?>
			...
			<script>
            	jQuery(document).ready(function ($) {
            		...
            		noty({
            			text: "<?php _e('PLEASE SOME BASIC INFORMATION ARE REQUIRED TO PROCEED','WPsmartcrm')?>",
            			layout: 'center',
            			type: 'error',
	...
	function smartcrm_checkbox_services() {
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Activate services module','WPsmartcrm').'</label>';
	...
	function smartcrm_select_style() {
		...
		$html .= '<option value="default">' . __( 'Select a style...', 'WPsmartcrm' ) . '</option>';
		$html .= '<option value="dark" ' . selected( $options['grid_style'], 'dark', false) . '>' . __( 'Dark', 'WPsmartcrm' ) . '</option>';
		$html .= '<option value="light" ' . selected( $options['grid_style'], 'light', false) . '>' . __( 'Light', 'WPsmartcrm' ) . '</option>';
		$html .= '</select></div>';
		echo $html;
	...
	function smartcrm_redirect(){
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Redirect to CRM dashboard on login','WPsmartcrm').'</label>';
	...
	function smartcrm_minimize_WP_menu(){
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Minimize Wp Main menu and use CRM fullpage ( Recommended )','WPsmartcrm').'</label>';
	...
	function smartcrm_administrator_noty(){
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Show notifications for all agents/users to site Administrators','WPsmartcrm').'</label>';
	...
	function smartcrm_show_future_activity(){
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Do not show activities marked as DONE or CANCELED older than one day in dashboard and scheduler','WPsmartcrm').'</label>';
	...
	function smartcrm_activity_deletion_privileges(){
		...
		{
			$html = '<label>'.__('Allow deletion of activities to administrators only','WPsmartcrm');
			...
			$html .= '<br>';
			$html .= '<label>'.__('Allow deletion of activities to administrators and creator','WPsmartcrm');
	...
	function smartcrm_agent_can(){
		...
		{
			$html = '<label>'.__('Allow agents to see documents and customers associated to other CRM Agents','WPsmartcrm');
			...
			$html .= '<br>';
			$html .= '<label>'.__('Allow an agent to see only documents and customers associated to himself','WPsmartcrm');
	...
	function smartcrm_company_logo(){
		...
		<div class="row">
			...
			<div class="uploader col-md-4">
				...
				<input style="margin-top:10px;text-align:center" class="button button-primary" value="<?php _e('Upload', 'WPsmartcrm')?>" onClick="open_media_uploader_images()"/>
			</div>
			<span style="width:100%;float:left;margin-top:10px;color:#999"><?php _e('Select your Company Logo to be used in documents ( invoices, offers etc..) best results with a square image 100px x 100px','WPsmartcrm')?></span>
			</div>
...
<?php }  
    ...
    function smartcrm_print_logo(){
		...
		$html .= '&nbsp;';
		$html .= '<label>'.__('Use Logo in documents','WPsmartcrm').'</label>';
	...
	function smartcrm_sender_email(){
		...
		$html .= '&nbsp;';
		$html .= '<label style="line-height:1em">'.__('Set a sender email address for CRM notification emails','WPsmartcrm').' <small><br />'.__('If blank the admin email will be used','WPsmartcrm').'</small></label></div>';
	...
	function smartcrm_sender_name(){
		...
		$html .= '&nbsp;';
		$html .= '<label style="line-height:1em">'.__('Set a sender name for CRM notification emails','WPsmartcrm').' <small><br />'.__('If blank the site name will be used','WPsmartcrm').'</small></label></div>';
	...
	function smartcrm_customers_grid_height(){
		...
		$html .= '&nbsp;';
		$html .= '<label style="line-height:1em">'.__('Set grid height ( in px ) for customers','WPsmartcrm').'</label></div>';
	...
	function smartcrm_documents_grid_height(){
		...
		$html .= '&nbsp;';
		$html .= '<label style="line-height:1em">'.__('Set grid height ( in px ) for documents','WPsmartcrm').'</label></div>';
	...
	function smartcrm_currency_select() {
		...
		$html .= '<option value="EUR"' . selected( $options['currency'], 'EUR', false) . '>' . __( 'EUR', 'WPsmartcrm' ) . '</option>';
		$html .= '<option value="USD"' . selected( $options['currency'], 'USD', false) . '>' . __( 'USD', 'WPsmartcrm' ) . '</option>';
		$html .= '<option value="CHF"' . selected( $options['currency'], 'CHF', false) . '>' . __( 'CHF', 'WPsmartcrm' ) . '</option>';
		$html .= '<option value="BRL"' . selected( $options['currency'], 'BRL', false) . '>' . __( 'BRL', 'WPsmartcrm' ) . '</option>';
		$html .= '</select></div></div>';
	...
	function smartcrm_gateway_select() {
		...
		$html .= '<option value="">'. __('Select','WPsmartcrm').'</option>';
...
<div class="row">
    <div class="panel panel-default col-md-9" style="margin:20px;padding-bottom:20px">
        <div id="stripe_config" style="display:none">
                <h3><?php _e('Stripe Configuration','WPsmartcrm')?></h3>
                <p><?php _e('Use your stripe account settings here','WPsmartcrm')?></p>
...
<script>
	...
	<div class="row" style="border-bottom:1px solid #000;padding-bottom:20px;margin-bottom:10px">
		...
		<div class="row" style="margin-bottom:10px;padding-bottom:10px;border-bottom:2px solid #ccc">
            ...
            <div class="col-md-3">
                <label>
                    <?php _e('Show customers Category in grid','WPsmartcrm')?>?
                </label>
        ...
        <div class="row" style="margin-bottom:10px;padding-bottom:10px;border-bottom:2px solid #ccc">
            ...
            <div class="col-md-3">
                <label>
                    <?php _e('Show customers Interests in grid','WPsmartcrm')?>?
                </label>
        ...
        <div class="row" style="margin-bottom:10px;padding-bottom:10px;border-bottom:2px solid #ccc">
            ...
            <div class="col-md-3">
                <label>
                    <?php _e('Show customers Origin in grid','WPsmartcrm')?>?
                </label>
	...
	<div id="innerTabstrip">
        <ul>
			<li class="k-state-active">
				<?php _e('Documents settings','WPsmartcrm')?>
			</li>
            <li >
                <?php _e('Document header','WPsmartcrm')?>
            </li>
            
            <li>
                <?php _e('Payment methods','WPsmartcrm')?>
            </li>
            <li>
                <?php _e('Messages','WPsmartcrm')?>
            </li>
            <li>
                <?php _e('Signature','WPsmartcrm')?>
            </li>
            <li>
                <?php _e('Custom Style','WPsmartcrm')?>
            </li>
			<?php
        ...
        <!-- Impostazioni varie (iva notifiche, numerazione etc) --><div>
                    ...
                    <div id="global_vat">
                        <div class="widget col-md-5 pull-left">
                            <h3><span class="crmHelp crmHelp-dark" data-help="default-vat"></span>
                                <?php _e('Default VAT and Currency','WPsmartcrm')?>
                            </h3>
                            <div>
                                <div class="col-md-4 pull-left">
                                    <label style="font-size:1.4em; position:relative;top:-5px"><?php _e('VAT','WPsmartcrm')?> (%) </label>
                                ...
                                <div class="col-md-6 pull-right">
									...
									$html .= '<option value="default">'.__('Select','WPsmartcrm').'</option>';
                    ...
                    <div id="payment_notification">
                        <div class="widget col-md-5 pull-right">
                            <h3><span class="crmHelp crmHelp-dark" data-help="payment-notification"></span>
                                <?php _e('Days after payment notification','WPsmartcrm')?>
                            </h3>
                ...
                <div class="row">
                    <div id="_header_invoices_numbering">
                        <div class="widget col-md-5 pull-left">
                            <h3><span class="crmHelp crmHelp-dark" data-help="document-numbering"></span>
                                <?php _e('Invoices Numbering settings','WPsmartcrm')?>
                            </h3>

                            <div>
                                <div class="col-md-10">
                                    <label class="col-md-10">
                                        <?php _e('Invoice prefix','WPsmartcrm')?>
                                    </label>
                                    ...
                                    <label class="col-md-10">
                                        <?php _e('Invoice suffix','WPsmartcrm')?>
                                    </label>
                                    ...
                                    <label class="col-md-10">
                                        <?php _e('Invoices last insert','WPsmartcrm')?>
                                    </label>
                    ...
                    <div id="_header_offers_numbering">
                        <div class="widget col-md-5 pull-right">
                            <h3><span class="crmHelp crmHelp-dark" data-help="document-numbering"></span>
                                <?php _e('Offers Numbering settings','WPsmartcrm')?>
                            </h3>

                            <div>
                                <div class="col-md-10">
                                    <label class="col-md-10">
                                        <?php _e('Offers prefix','WPsmartcrm')?>
                                    </label>
                                    ...
                                    <label class="col-md-10">
                                        <?php _e('Offers suffix','WPsmartcrm')?>
                                    </label>
                                    ...
                                    <label class="col-md-10">
                                        <?php _e('Offers last insert','WPsmartcrm')?>
                                    </label>
                    	...
                    	jQuery(document).ready(function($){
                    		$('#invoices_start').on('input', function () {
                    			if( $(this).val() < <?php echo isset($document_options['invoices_start']) ? $document_options['invoices_start'] : 0 ?> )
									alert("<?php _e('Warning: you\'re inputing a number lower than last invoice issued, be careful, this can cause problems with duplicated id','WPsmartcrm')?>");
                    		})
                    		$('#offers_start').on('input', function () {
                    			if( $(this).val() < <?php echo isset($document_options['invoices_start']) ? $document_options['invoices_start'] : 0 ?> )
									alert("<?php _e('Warning: you\'re inputing a number lower than last quote issued, be careful, this can cause problems with duplicated id','WPsmartcrm')?>");
                    		})
                    	})
					</script>
                </div>
        ...
        <!--IMPOSTAZIONI ALLINEAMENTO ELEMENTI --><div>
            ...
            <div id="_header_align">
                <div class="dash-head hidden-on-narrow">
                    <h4 style="text-align: center;" class="page-header"><span class="crmHelp crmHelp-dark" data-help="header-align"></span><?php _e('Drag elements (left-right) to align them in documents ','WPsmartcrm')?> </h4>
                </div>
		...
		<div id="_payments">
			<div class="dash-head hidden-on-narrow">
                <h4 style="text-align: center;margin:30px auto" class="page-header" >
                    <?php _e('Payment methods definitions','WPsmartcrm')?><span class="crmHelp crmHelp-dark" data-help="options-payments-definitions"></span>
                </h4>
            </div>
            <div class="panel-wrap hidden-on-narrow row">
				<div class="col-md-4">
					<div class="input-group">
                        <label>
                            <?php _e('Label','WPsmartcrm')?> <span style="color:red">*</span>
                            <input type="text" id="addPayment" class="form-control _m" />
                        </label>
                        <label>
                            <?php _e('Days','WPsmartcrm')?>
                            <input type="number" id="daysPayment" class="form-control _m" />
                        </label>
						<span class="input-group-btn">
						<button class="btn btn-default" id="_savePayment" type="button" style="margin-top:40px"><?php _e('Add','WPsmartcrm')?> &raquo;</button>
						</span>
					</div>
					</div>
		...
		if (!empty($arr_payments ) )
			...
			jQuery(document).ready(function ($) {
				$('#_savePayment').on('click', function () {
					...
					var e;
					days != "" ? (days = ("~" + days), e="("+ days +" <?php _e('dd','WPsmartcrm')?>)"): (days = "" ,e="");
				...
				for (var k = 0; k < pay.length; k++) {
					var m = pay[k].split('~');
					if (m[1] != undefined)
						m = m[0] + " (" + m[1] + " <?php _e('dd','WPsmartcrm')?>)";
					else m = pay[k];
        ...
        <!-- MESSAGGI FATTURE / PREVENTIVI--><div>
            ...
            <div id="_header_invoices_messages">
                <div class="dash-head hidden-on-narrow">
				<h4 style="text-align: center;margin:30px auto" class="page-header" ><span class="crmHelp crmHelp-dark" data-help="document-messages"></span><?php _e('INVOICES MESSAGES SETTINGS','WPsmartcrm')?> </h4></div>
                <div class="panel-wrap hidden-on-narrow row">
                    <div class="col-md-12 _messages">
                        <div class="item">
                            <label><?php _e('Dear','WPsmartcrm')?></label>
                        ...
                        <div class="item">
                            <label><?php _e('Invoices before text','WPsmartcrm')?></label>
                        ...
                        <div class="item">
                            <label><?php _e('Invoices after text','WPsmartcrm')?></label>
            ...
            <div id="_header_offers_messages">
                <div class="dash-head hidden-on-narrow">
					<h4 style="text-align: center;margin:30px auto" class="page-header"><span class="crmHelp crmHelp-dark" data-help="document-messages"></span><?php _e('OFFERS MESSAGES SETTINGS','WPsmartcrm')?> </h4>
				</div>
                <div class="panel-wrap hidden-on-narrow row _messages">
                    <div class="col-md-12">
                        ...
                        <div class="item">
                            <label><?php _e('Offers before text','WPsmartcrm')?></label>
                        ...
                        <div class="item">
                            <label><?php _e('Offers after text','WPsmartcrm')?></label>
            ...
            <div id="_signature" >
                ...
                <div class="dash-head hidden-on-narrow">
                    <h1 style="text-align:center">
                        <?php _e('Signature settings','WPsmartcrm')?>
                    </h1>
                    <h4 style="text-align: center; padding: 12px;background-color:gainsboro;">
                        <?php _e('Draw your signature (mouse or touch) to be used in offers','WPsmartcrm')?>
                    </h4>
                </div>
                <div class="panel-wrap hidden-on-narrow row" style="margin-top:20px">
                    ...
                    <div id="signature-pad" class="m-signature-pad">
                        ...
                        <div class="m-signature-pad--footer">
                            ...
                            <button type="button" class="btn btn-warning btn-sm _flat" data-action="clear">
                                <?php _e('Reset','WPsmartcrm')?>
                            </button>
                            <button type="button" class="btn btn-success btn-sm _flat" data-action="save">
                                <?php _e('Save','WPsmartcrm')?>
                            </button>
                            <div style="float:right;margin-right:100px">
                                <label>
                                    <?php _e('Use this Signature','WPsmartcrm')?>?
                                </label>
                    ...
                    <h4 style="text-align: center; padding: 12px;background-color:gainsboro;">
                        <?php _e('Formatted signature ( i.e. company name)','WPsmartcrm')?>
                    </h4>
		...
		<!--CUSTOM CSS--><div>
                    <div id="_custom_css">
                        <div class="dash-head hidden-on-narrow">
                            <h1 style="text-align:center">
                                <?php _e('Custom css','WPsmartcrm')?>
                            </h1>
                            <h4 style="text-align: center; padding: 12px;background-color:gainsboro;">
                                <?php _e('Add or overwrite existing style in PDF documents','WPsmartcrm')?>
                            </h4>
                        </div>
                        <div class="panel-wrap hidden-on-narrow row" style="margin-top:20px">
                            <div class="col-md-12">
							...
							<p><?php _e('Use these CSS rules to adjust the layout of the printable version of your documents (available after a document has been created)','WPsmartcrm')?>. </p>
						</div>
                    </div>
                </div><!--END CUSTOM CSS-->
    </div>
		...
		$this->plugin_options_tabs(); ?>
            ...
            <div class="row">
			    ...
			    <form method="post" action="options.php">
                    ...
                    <span class="" style="padding:12px"><input type="submit" name="submit" id="submit" class="_flat btn btn-success" value="<?php _e('Save','WPsmartcrm')?>" style="margin: 30px;<?php if($_GET['tab']=="CRM_business_settings") { ?>display:none;<?php } ?>" ></span>
			    </form>
                </div>
