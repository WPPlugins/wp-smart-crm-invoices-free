...
function WPsCRM_register_CRM_plugins() {
    ...
    $config = array(
        ...
        'installing' => __( 'Installing Plugin: %s', 'WPsmartcrm' ), // %s = plugin name.
        'oops' => __( 'Something went wrong with the plugin API.', 'WPsmartcrm' ),
        ...
        'complete' => __( 'All plugins installed and activated successfully. %s', 'WPsmartcrm' ), // %s = dashboard link.
