...
function WPsCRM_customers_tax() {
    ...
    'search_items'      => __( 'Search interest','WPsmartcrm' ),
    'all_items'         => __( 'All interests','WPsmartcrm' ),
    'edit_item'         => __( 'Edit interest','WPsmartcrm' ),
    'update_item'       => __( 'Update interest','WPsmartcrm' ),
    'add_new_item'      => __( 'Add interest','WPsmartcrm' ),
    'new_item_name'     => __( 'New interest','WPsmartcrm' ),
    'menu_name'         => __( 'Interests','WPsmartcrm' ),
    );
    $args = array(
    'hierarchical'      => true,
    'labels'            => $labels,
   ...
   'singular_name'     => _x( 'Category', 'taxonomy singular name' ),
   'search_items'      => __( 'Search category','WPsmartcrm' ),
   'all_items'         => __( 'All categories','WPsmartcrm' ),
   'edit_item'         => __( 'Edit category','WPsmartcrm' ),
   'update_item'       => __( 'Update category','WPsmartcrm' ),
   'add_new_item'      => __( 'Add category','WPsmartcrm' ),
   'new_item_name'     => __( 'New category','WPsmartcrm' ),
   'menu_name'         => __( 'Categories','WPsmartcrm' ),
   );
    $args = array(
    'hierarchical'      => true,
    'labels'            => $labels,
   ...
   'search_items'      => __( 'Search origin','WPsmartcrm' ),
   'all_items'         => __( 'All Origins','WPsmartcrm' ),
   'edit_item'         => __( 'Edit Origin','WPsmartcrm' ),
   'update_item'       => __( 'Update Origin','WPsmartcrm' ),
   'add_new_item'      => __( 'Add Origin','WPsmartcrm' ),
   'new_item_name'     => __( 'New Origin','WPsmartcrm' ),
   'menu_name'         => __( 'Origins','WPsmartcrm' ),
   );
    $args = array(
    'hierarchical'      => true,
    'labels'            => $labels,
...
function smart_crm_menu(){
	...
	add_submenu_page(
			'smart-crm',
			__('WP SMART CRM NOTIFICATION RULES', 'WPsmartcrm'),
			__('Notification rules', 'WPsmartcrm'),
			'manage_options',
	...
	add_submenu_page(
			'smart-crm',
			__('WP SMART CRM Customers', 'WPsmartcrm'),
			__('Customers', 'WPsmartcrm'),
			'manage_crm',
	...
	add_submenu_page(
			'smart-crm',
			__('WP SMART CRM Scheduler', 'WPsmartcrm'),
			__('Scheduler', 'WPsmartcrm'),
			'manage_crm',
	...
	add_submenu_page(
			'smart-crm',
			__('WP SMART CRM Documents', 'WPsmartcrm'),
			__('Documents', 'WPsmartcrm'),
			'manage_crm',
