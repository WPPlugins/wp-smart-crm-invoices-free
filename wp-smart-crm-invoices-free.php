...
function WPsmartcrm_l10n(){
    ...
    load_plugin_textdomain( 'WPsmartcrm', false, dirname(plugin_basename( __FILE__ )).'/languages/' );
...
add_action('init','WPsmartcrm_l10n',99);
...
<div class="notice notice-error">
	<p>
		<?php _e( 'Warning:  some basic settings are required','WPsmartcrm');?>
		<a href="<?php echo admin_url("admin.php?page=smartcrm_settings&tab=CRM_business_settings" )?>">
			<?php _e('on this page','WPsmartcrm');?>
		</a>
		<?php _e('to use WP Smart CRM ','WPsmartcrm')?>!
	</p>
</div>
<?php
}
